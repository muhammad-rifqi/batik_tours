            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="dashboard-box">
                        ...
                        <form class="form-horizontal" method="post" action="<?= base_url('admin/update_country')?>">
                        <input type="hidden" name="id_country" value="<?= $country[0]['id_country']?>">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Country</label>
                                        <input name="name" class="form-control" type="text" value="<?= $country[0]['name']?>">
                                    </div>
                                </div>
                            </div>
                            <br>

    ...
    <div id="dashboard" class="dashboard-container">
        ...
        <div class="db-info-wrap db-package-wrap">
            <div class="dashboard-box table-opp-color-box">
                <h4>Packages List Pending</h4>
                <p>Your Packages List Pending.</p>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-danger" style="cursor:pointer" onclick="window.location.href='<?= base_url('admin/delete_package/package_pending/'.$package[$i]['id_package'])?>'"><i class="far fa-trash-alt"></i></span>
                                </td>
                            </tr>
                           <?php } ?>
                        </tbody>

        ...
        <div class="inner-baner-container"
            ...
            <div class="container">
                <div class="inner-banner-content">
                    <h1 class="inner-title"> Tour Package </h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="package-wrap">
                            <figure class="feature-image">
                                <a href="<?= base_url('detail-package/'.$search[$i]['slug'])?>">
                                    <!-- ukuran 365 x 305 -->
                                    <img src="<?= $search[$i]['photo']?>" alt="">
                                </a>
                            </figure>
                            <div class="package-price">
                                <h6>
                                    <span>IDR <?= number_format($search[$i]['price'],0,',','.')?> </span> / per pax
                                </h6>
                            </div>
                            <div class="package-content-wrap">
                                <div class="package-meta text-center">
                                    <ul>
                                        <li>
                                            ...
                                            <?= $search[$i]['day']?>D/<?= $search[$i]['night']?>N
                                        </li>
                                        <li>
                                ...
                                <div class="package-content">
                                    <h3>
                                        <a href="<?= base_url('detail-package/'.$search[$i]['slug'])?>">Paket Hemat Liburan di <?= $search[$i]['cities']?></a>
                                    </h3>
                                    <div class="review-area">
                                        <span class="review-text">(<?= $search[$i]['star']?> ulasan)</span>
                                        <div class="rating-start" title="Rated 5 out of 5">
                                            <span style="width: 100%"></span>
                                        </div>
                                    </div>
                                    <p><?= substr($search[$i]['description'],0,200)?>....</p>
                                    <div class="btn-wrap">
                                        <a href="<?= base_url('detail-package/'.$search[$i]['slug'])?>" class="button-text width-6">Pesan Sekarang<i
